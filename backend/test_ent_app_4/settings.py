"""
Django settings for test_ent_app_4 project.
...
ROOT_URLCONF = 'test_ent_app_4.urls'
...
WSGI_APPLICATION = 'test_ent_app_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_ent_app_4 API",
    "DESCRIPTION": "API documentation for test_ent_app_4 App",
    "VERSION": "v1",
}
